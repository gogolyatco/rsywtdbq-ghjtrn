...
row_1.addWidget (button_notes_del)

row_2 = QHBoxLayout()
row_2.addWidget (button_notes_save)
...
button_notes_del.clicked.connect(del_note)
#
#
...
button_notes_del.clicked.connect(del_tag)
